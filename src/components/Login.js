    ...
    render(){
        return(
            <div>
				...
				<input id='input' type="email" name="email" required onChange={this.email}/><br/><br/>
				<label >Password</label><br/><br/>
				<input  id='input'type="password" name="password" required onChange={this.password}/><br/><br/>
